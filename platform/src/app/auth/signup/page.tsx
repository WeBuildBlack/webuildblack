  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <h1 className="text-3xl font-heading font-bold text-brand-dark-brown text-center mb-2">
          Create Your Account
        </h1>
        <p className="text-center text-brand-dark-gray font-body mb-8">
        ...
        <p className="text-center text-xs text-brand-medium-gray font-body">
          For WBB Slack members — instant free access to all courses
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="fullName" className="block text-sm font-accent font-bold text-brand-dark-gray mb-1">
              Full Name
            </label>
            <input
              id="fullName"
        ...
        <p className="text-center text-brand-dark-gray font-body mt-6">
          ...
          <Link href="/auth/login" className="text-brand-medium-brown font-bold hover:underline">
            Sign in
          </Link>
        </p>
      </div>
